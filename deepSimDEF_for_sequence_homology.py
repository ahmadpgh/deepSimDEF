# CUDA_VISIBLE_DEVICES=3 python deepSimDEF_for_sequence_homology.py
...
if __name__ == "__main__": 
    ...
    gene_1, gene_2, gene_1_annotation, gene_2_annotation, prediction_value = sequence_homology_dataset(
        sequence_homology_data_dir, data_file_name, sub_ontology_all, fully_annotated_genes, gene_annotations,
