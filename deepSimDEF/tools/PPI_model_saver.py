...
def save_model(FOLD, models):

    project_path = "deepSimDEF/model_repository/model_weights/"
...
def save_embeddings(FOLD, embedding_layers, word_indeces, SUB_ONTOLOGY_work, embedding_save):
    
    for ind in range(FOLD):
        
        project_path = "deepSimDEF/model_repository/model_updated_embeddings/"
        ...
        for sbo in SUB_ONTOLOGY_work:
            ...
            file_writer = open(project_path + embedding_save[sbo] + "_Model_" + str(ind + 1), "w")
